...
import br.ufrn.imd.cine.services.ai.CarAIService;
...
public class SessionService extends GenericService<Session> {
	...
	@Autowired
	private CarAIService oaiService;
	...
	public List<Session> findSessionsRecommendated(User userLogged) throws Exception {
		List<Movie> moviesWatched = ticketRepository.findByOwnersContaining(userLogged).get().stream()
